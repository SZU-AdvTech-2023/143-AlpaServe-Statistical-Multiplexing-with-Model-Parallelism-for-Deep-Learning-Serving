...
def plot_goodput_common(azurev1_data, azurev2_data, threshold, increasing, xlabel, output, ybottem, plot_legend=False):
    ...
    for data, ax, title in zip(azurev1_data + azurev2_data, axs, titles):
        ...
        ###################modified
        substring_to_keep = 'mp-search'
        methods = [item for item in methods if substring_to_keep in item]
        ##########################
...
if __name__ == "__main__":
    ...
    plot_goodput_vs_num_devices(azure_v1_lines, azure_v2_lines, threshold, args.output_dir, args.pdf, 10, True)
    plot_goodput_vs_rate_scale(azure_v1_lines, azure_v2_lines, threshold, args.output_dir, args.pdf, 20)
    plot_goodput_vs_cv_scale(azure_v1_lines, azure_v2_lines, threshold, args.output_dir, args.pdf, 20)
