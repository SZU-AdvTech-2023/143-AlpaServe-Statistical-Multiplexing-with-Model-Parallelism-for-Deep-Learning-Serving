...
if __name__ == "__main__":
    ...
    if "goodput_vs_num_devices" in experiments:#4*3
    ...
    #### goodput vs slo #####
    if "goodput_vs_slo" in experiments:#8*3
    ...
    if "goodput_vs_rate" in experiments:#8*3
        if args.workload == "synthetic":
    ...
    if "goodput_vs_cv" in experiments:#8*3
        if args.workload == "synthetic":
